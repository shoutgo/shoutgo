...
/*extern *//*inline */ BITB strip (const POS & pos, int horizontal, int vertical, DIRECTION d = CENTER);
/*extern *//*inline */ BITB strip (const POS & pos, int up, int left, int down, int right);
