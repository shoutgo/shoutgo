...
/* class COMMAND */
enum { HELP_C, VERSION_C, PLAY_C, FIR_C, REVIEW_C, SGFTREE_C, INPUTPAT_C, SIZE_C, EXIT_C, PASS_C, END_C, HISTORY_C, SHOWBOARD_C, DELTAMASSMAPS_C, MASSMAPS_C, CLUSTER_C, POTENTIAL_C, PUBLICAREA_C, ALIVE_C, DEAD_C, UNCLEAR_C, LAND_C, SEA_C, AIR_C, ZOBRIST_C, PEMIS_C, SCAN_C, TRYMOVE_C, SAVE_C, SAVE2SGF_C, BACK_SAVE2TXT_C, CMD_SIZE };
...
private:
  struct CMD
  {
    ...
    CMD (VS n, string f = "", string e = "", string c = ""):names (n), format (f), english (e), chinese (c)
    {
    }
  };
  CMD cmd[CMD_SIZE];
